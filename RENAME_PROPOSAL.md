...
|------|------|------|------|-------------------|
| 1 | **cm-expert-llm** | Short, memorable, combines "condensed" + "AI", unique | May be confused with general condensed matter AI (not just LLM) | âœ?Need to verify |
...
- Good if cm-expert-llm is taken
